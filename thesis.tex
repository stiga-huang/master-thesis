...
\pkuthssinfo{
	...
	ctitle = {HybriG: 一种高效处理大量重边的属性图存储架构}, etitle = {HybriG: A Distributed Architecture for Property Graph with Large Set of Multi-edges},
	cauthor = {黄权隆},
...
\begin{document}
	...
	\include{chap/hybrig_design}
	\include{chap/experiments}
	% 结论。
